 ...
 */
final class Version20230318211636 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE commentaire DROP FOREIGN KEY fk_commentaire_client');
        $this->addSql('ALTER TABLE commentaire DROP FOREIGN KEY fk_commentaire_conducteur');
        ...
        $this->addSql('DROP INDEX fk_commentaire_conducteur ON commentaire');
        $this->addSql('DROP INDEX fk_commentaire_client ON commentaire');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE commentaire ADD CONSTRAINT fk_commentaire_client FOREIGN KEY (id_client) REFERENCES client (id_client)');
        $this->addSql('ALTER TABLE commentaire ADD CONSTRAINT fk_commentaire_conducteur FOREIGN KEY (id_conducteur) REFERENCES conducteur (id_conducteur)');
        $this->addSql('CREATE INDEX fk_commentaire_conducteur ON commentaire (id_conducteur)');
        $this->addSql('CREATE INDEX fk_commentaire_client ON commentaire (id_client)');
    }
}
