...
class ReservationController extends AbstractController
{
    ...
    {
        $reservation = new Reservation();
        $form = $this->createForm(OffreType::class, $reservation);
        $form->handleRequest($request);
    ...
    public function newfrontreserver(Request $request, ReservationRepository $reservationRepository,OffreRepository $offreRepository,MailerInterface $mailer): Response
    {
        $reservation = new Reservation();
        $offre = new Offre();
        $form = $this->createForm(ReservationType::class, $reservation);
