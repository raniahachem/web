...
// http://127.0.0.1:8001/payement/save?clientId=1&modePayment=".$abonnement->getModePaiementAb()."&prixCourse=".$abonnement->getPrixAb();
        $successUrl = "http://127.0.0.1:8001/payement/savep/1/".$abonnement->getModePaiementAb()."/".$abonnement->getPrixAb();
     //   "/savep/1/".$abonnement->getModePaiementAb()."/"$abonnement->getPrixAb()
        ...
        $mail = (new Email())
            ...
            ->html('<a href="'.$link.'">lien pour valider paiement ,  !</a><br>merci de payer');
